...
<nav class="navbar navbar-inverse">
	...
	<ul class="nav navbar-nav">
		<li><a href="{{ URL::to('/grupoalertas/create') }}">Crear nuevo Alerta</a>
	</ul>
</nav>
		...
		<div class="col-sm-6">
			<section class="panel panel-default">
				...
				<div class="panel-body">
					{{ Form::open(array('url' => URL::to('grupoalertas/' . $grupoalerta->id), 'method' => 'PUT', 'class' => 'panel-body wrapper-lg')) }}
