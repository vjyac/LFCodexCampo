...
<div class="row">
	...
	{{ Form::open(array('route' => 'movimientos.reporteproductoporcontratista', "autocomplete"=>"off"
				          ...
				          @endif
								...
								<div class="row">
									...
									<label>Fecha desde</label>
										{{ Form::text('fecha_desde', '', array('class' => 'datepicker-input form-control input-lg', 'id' =>'fecha_desde', 'placeholder' => 'Fecha desde', 'data-date-format' => 'dd-mm-yyyy')) }}
									</div>
								</div>
								...
								<div class="row">
									...
									<label>Fecha hasta</label>
										{{ Form::text('fecha_hasta', '', array('class' => 'datepicker-input form-control input-lg', 'id' =>'fecha_hasta', 'placeholder' => 'Fecha hasta', 'data-date-format' => 'dd-mm-yyyy')) }}
									</div>
								</div>
								...
								<div class="form-group">
									<label>Destino</label>
									{{ Form::text('contratista', '', array('class' => 'form-control input-lg', 'id' =>'contratista', 'placeholder' => 'Ingrese el proveedor contratista')) }}
									{{ Form::hidden('contratista_id' , Input::old('contratista_id'), array('id' =>'contratista_id')) }}	 
								</div>	 
								...
								<div class="form-group">
									...
									{{ Form::text('producto', '', array('class' => 'form-control input-lg', 'id' =>'producto', 'placeholder' => 'Ingrese un producto, vacio todos')) }}
