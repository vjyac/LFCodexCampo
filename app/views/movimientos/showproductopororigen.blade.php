...
<div class="row">
	...
	{{ Form::open(array('route' => 'movimientos.reporteproductopororigen', "autocomplete"=>"off"
, 'class' => 'panel-body wrapper-lg')) }}
				          ...
				          @endif
								...
								<div class="form-group">
									<label>Origen</label>
									{{ Form::text('proveedor', '', array('class' => 'form-control input-lg', 'id' =>'proveedor', 'placeholder' => 'Ingrese el proveedor origen')) }}
