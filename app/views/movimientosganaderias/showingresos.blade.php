...
<div class="row">
	...
	{{ Form::open(array('route' => 'movimientosganaderias.reporteingresos', "autocomplete"=>"off"
, 'class' => 'panel-body wrapper-lg')) }}
				          ...
				          @endif
								...
								<div class="form-group">
									<label>Origen</label>
									{{ Form::text('destino', '', array('class' => 'form-control input-lg', 'id' =>'destino', 'placeholder' => 'Ingrese un origen')) }}
